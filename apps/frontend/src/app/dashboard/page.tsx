    ...
    <Navigation activeTab="dashboard">
      <div className="flex-1 flex flex-col gap-6">
        ...
        <div className="glass-panel p-6 rounded-3xl flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 shrink-0 shadow-sm select-none">
          <div>
            <h1 className="text-2xl font-black tracking-tight text-slate-800 dark:text-white flex items-center gap-2 uppercase">
              <Layers className="w-6 h-6 text-indigo-500 animate-pulse" /> {activeSettings?.restaurantName || 'Analytics Terminal Dashboard'}
            </h1>
            <p className="text-xs font-semibold text-slate-400 mt-1">
              {activeSettings?.restaurantName ? 'Analytics Terminal Dashboard • ' : ''}Active sales overview, billing channels, dining statuses, and outlays
            </p>
          </div>
